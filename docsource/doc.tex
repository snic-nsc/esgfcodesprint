...
\end{enumerate}
\section{Instructions for setting up ESGF}
Now that your vm(s) are ready, you can refer to \url{https://github.com/ESGF/esgf-installer/wiki/ESGF-Installation-Using-Autoinstaller} for instructions on setting up a new ESGF installation.
