...
if enablepub != None:
	try:
		...
		qadduser="insert into esgf_security.user(firstname,lastname,email,username,password,openid,organization,city,country,status_code,verification_token) values('Publisher','Tester','pt@example.org','testpub','$1$GnNDs7Ed$M5hLjBHVOTJGZv4TcNCFU0','https://%s/esgf-idp/openid/testpub','ABC','Linkoping','SWEDEN','1','5e1e0178-301c-4187-978a-321a50dba887')"%enablepub
