...
esgpublish --map mapfiles/test.map --project cordex --new-version `date +%Y%m%d` --noscan --thredds
esgpublish --map mapfiles/test.map --project cordex --new-version `date +%Y%m%d` --noscan --publish
